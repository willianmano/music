...
//         var g = b.detail < 0 || b.wheelDelta > 0 ? 1 : -1;
//         var d = a(".active").val();
//         if (mode == "tab-edit") {
//             var c = selection.getK();
...
//                     } else {
//                         if (i != -1) {
//                             if (h.note.keys.length > 1) {
//                                 h.note.keys.removeAt(h.getIndex())
//                             } else {
//                                 h.note.convertToRest()
//                             }
//                         }
//                     }
//                 } else {
//                     if (h.note.isRest()) {
//                         handler.parseTabInput(0, d)
//                     } else {
//                         if (h.fret >= 0) {
//                             h.fret += 1
//                         }
...
// $(document).ready(function () {
//     key("left", function () {
//         handler.moveToPrevNote();
//         score.reset()
//     });
//     key("right", function () {
//         handler.moveToNextNote();
//         score.reset()
//     });
//     key("up, shift+up", function () {
//         if (mode == "notation-edit") {
//             handler.moveUpKey()
//         } else {
//             if (mode == "tab-edit") {
//                 handler.moveUpString()
//             }
//         }
//         score.reset();
//         return false
//     });
//     key("down, shift+down", function () {
//         if (mode == "notation-edit") {
//             handler.moveDownKey()
//         } else {
//             if (mode == "tab-edit") {
//                 handler.moveDownString()
//             }
//         }
//         score.reset();
//         return false
...
//         handler.appendNextNote();
//         score.reset()
//     });
//     key("ctrl+up", function () {
//         handler.shiftOctaveUp();
//         score.reset()
//     });
//     key("ctrl+down", function () {
//         handler.shiftOctaveDown();
//         score.reset()
//     });
//     key("ctrl+a", function () {
//         selection.getM().forEach(function (b) {
//             b.notes.forEach(function (c) {
//                 selection.add(c.keys)
//             })
//         });
//         score.reset();
//         return false
...
//         handler.moveToNextMeasure();
//         score.reset()
//     });
//     key("shift+ctrl+right", function () {
//         handler.increaseSelection();
//         score.reset()
//     });
//     key("shift+ctrl+left", function () {
//         handler.decreaseSelection();
//         score.reset()
//     });
//     key("tab", function () {
//         a();
...
//         score.reset()
//     });
//     key("ctrl+delete", function () {
//         $("#deleteMeasure").trigger("click");
//         score.reset()
//     });
//     key("r", function () {
//         handler.convertToRests();
...
//     });
//     key("-", function () {
//         handler.decreaseDuration();
//         score.partLinks[1].convertTabToNotation(selection.getM()[0].getIndex());
//         score.reset()
//     });
//     key("+, =", function () {
//         handler.increaseDuration();
//         score.partLinks[1].convertTabToNotation(selection.getM()[0].getIndex());
//         score.reset()
//     });
//     key(".", function () {
...
//     });
//     key("ctrl + .", function () {
//         handler.increaseDots();
//         score.reset()
//     });
//     key("b", function () {
//         selection.getK().forEach(function (b) {
//             b.addArticulation(Editor.articulations.BEND_HALF)
//         });
//         score.reset()
//     });
//     key("v", function () {
//         selection.getK().forEach(function (b) {
//             b.addArticulation(Editor.articulations.VIBRATO)
//         });
//         score.reset()
//     });
//     key("h", function () {
//         selection.firstNote().modifiers.push("hammer," + selection.keyIndex);
//         score.reset()
//     });
//     key("1,2,3,4,5,6,7,8,9,0", function (c, b) {
//         if (mode == "tab-edit") {
//             handler.parseTabInput(parseInt(b.shortcut, 10), $(".active").val());
//             score.partLinks[1].convertTabToNotation(selection.getM()[0].getIndex());
//             score.reset()
//         }
//     });
//     key("space", function () {
//         var c = selection.getN().last();
//         if (c) {
//             var f = c.measure;
//             var d = f.notes.length - 1;
//             d = c.getIndex();
//             var b = new Editor.Note().addKey(new Editor.Key("b/4")).setDuration($(".active").val()).convertToRest();
//             f.addNote(b, d + 1);
//             selection.reset().add(b.keys.first());
//             score.partLinks[1].convertTabToNotation(selection.getM().last().getIndex());
//             score.reset();
